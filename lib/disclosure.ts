 ...
 */
export function spokenDisclosure(): string {
 ...
 */
export function identificationBlock(who: CorretorIdentity): string {
...
export function humanReplyAffordance(): string {
