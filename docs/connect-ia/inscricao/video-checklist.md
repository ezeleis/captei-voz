# Checklist — vídeo Captei (Connect IA)

Referência: Edital item 6.3 — https://forms.gle/LSNnsPoCuKFNpdJY7

## Pré-gravação

- [ ] Roteiro ensaiado — **≤ 3:00** ([`video-roteiro.md`](video-roteiro.md))
- [ ] Apresentador = **Facundo Ezequiel Leis Pou** (representante / CRECI)
...
- [ ] Por que Connect IA / Florianópolis

## Pós-gravação

- [ ] Export ≤ 3:00
- [ ] Upload YouTube (não listado) ou Drive
- [ ] Link testado em aba anônima
- [ ] Colar no formulário antes **20/09/2026 23:59**
- [ ] **Não** trocar vídeo após prazo
